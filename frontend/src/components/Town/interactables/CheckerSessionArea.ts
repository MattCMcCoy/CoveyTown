...
export default class CheckerSessionArea extends Interactable {
  ...
  addedToScene() {
    ...
    this._labelText = this.scene.add.text(
      ...
      `Press space to look at the ${this.name} checker`,
      { color: '#FFFFFF', backgroundColor: '#000000' },
    );
    this._labelText.setVisible(false);
    // this.townController.getCheckerSessionAreaController(this);
    this.setDepth(-1);
  }
