...
import CheckerSessionArea from './CheckerSessionArea';
...
export function CheckerViewer(): JSX.Element {
...
export default function CheckerViewerWrapper(): JSX.Element {
  const checkerSessionArea = useInteractable<CheckerSessionArea>('checkerSessionArea');
  if (checkerSessionArea) {
    return <CheckerViewer />;
  } else {
    // return <></>;
    return <CheckerViewer />;
  }
